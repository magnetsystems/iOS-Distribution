Pod::Spec.new do |s|
  ...
  # s.source             =  { :git => 'https://github.com/magnetsystems/message-ios-3.0.git', :tag => "tag-release-#{s.version}" }
  s.source             =  { :git => 'https://github.com/magnetsystems/message-ios-3.0.git', :branch => "develop" }
  ...
  s.dependency     'MagnetMaxCore', '~> 3.0'
